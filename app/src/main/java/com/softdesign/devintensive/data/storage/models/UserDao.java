...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Raiting = new Property(5, int.class, "raiting", false, "RAITING");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USERS\" (" + //
                ...
                "\"RAITING\" INTEGER NOT NULL ," + // 5: raiting
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(6, entity.getRaiting());
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getInt(offset + 5), // raiting
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setRaiting(cursor.getInt(offset + 5));
